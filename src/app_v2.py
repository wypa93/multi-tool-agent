    ...
    if isinstance(message,AIMessage):
        ...
        with st.chat_message("Human"):
            ...
            class Chatbot:
                ...
                def setup_llm(self, openai_api_key):
                ...
                def rag_tool_setup(self, openai_api_key):
                ...
                def main(self):
                    ...
                    if user_input is not None and user_input != "":
                        ...
                        tools = [self.query_dataframe]
                        # append rag_tool if text files are present
                        if st.session_state.docs is not None:
                            rag_tool = self.rag_tool_setup(openai_api_key)
                            tools.append(rag_tool)
                        agent = create_structured_chat_agent(self.llm, tools=tools, prompt=prompt)
